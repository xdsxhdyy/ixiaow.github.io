...
function(t, i, e, s) {
  function n(s, n) {
      ...
      this._container.length && (this.jQwindow = t(i), this.jQdocument = t(e), this._holder = t(s), this._nav = {},
      this._first = t(this.options.first), this._previous = t(this.options.previous), this._next = t(this.options.next), this._last = t(this.options.last), this._items = this._container.children(":visible"), this._itemsShowing = t([]), this._itemsHiding = t([]), this._numPages = Math.ceil(this._items.length / this.options.perPage), this._currentPageNum = this.options.startPage, this._clicked = !1, this._cssAnimSupport = this.getCSSAnimationSupport(), this.init())
  }
  var a = "jPages",
  h = null,
  o = {
  ...
  n.prototype = {
      ...
      getCSSAnimationSupport: function() {
          ...
          if (h.style.animationName && (t = !0), t === !1) for (var o = 0; o < n.length; o++) if (h.style[n[o] + "AnimationName"] !== s) {
              a = n[o],
              i = a + "Animation",
              e = "-" + a.toLowerCase() + "-",
              t = !0;
      ...
      writeNav: function() {
          var t, i = 1;
          for (t = "", t = '<nav><ul class="pagination">', t += this.writeBtn("first") + this.writeBtn("previous"); i <= this._numPages; i++) {
              switch (1 === i && 0 === this.options.startRange && (t += "<span>...</span>"), t += i > this.options.startRange && i <= this._numPages - this.options.endRange ? "<li><a href='#' class='jp-hidden'>": "<li><a>", this.options.links) {
              case "numeric":
                  t += i;
                  break;
              case "blank":
      ...
      writeBtn: function(i) {
          return this.options[i] === !1 || t(this["_" + i]).length ? "": "<li class=''><a class='jp-" + i + "'>" + this.options[i] + "</a></li>"
      },
      ...
      bindNavKeyBrowse: function() {
          this.jQdocument.bind("keydown.jPages", this.bind(function(t) {
              ...
              if (this.elemScrolledIntoView() && "input" !== i && "textarea" != i) {
                  ...
                  this.validNewPage(e) && (this._clicked = !0, this.paginate(e))
              }
          },
          this))
      },
      ...
      bindNavScrollBrowse: function() {
          this._container.bind("mousewheel.jPages DOMMouseScroll.jPages", this.bind(function(t) {
              ...
              return this.validNewPage(i) && (this._clicked = !0, this.paginate(i)),
              t.preventDefault(),
              !1
          },
          this))
      ...
      updateBtns: function(t, i) {
          1 === i && (t.first.parent().addClass("active"), t.previous.parent().addClass("active")),
          i === this._numPages && (t.next.parent().addClass("active"), t.last.parent().addClass("active")),
          1 === this._currentPageNum && i > 1 && (t.first.parent().removeClass("active"), t.previous.parent().removeClass("active")),
          this._currentPageNum === this._numPages && i < this._numPages && (t.next.parent().removeClass("active"), t.last.parent().removeClass("active"))
      },
  ...
  t.fn[a] = function(i) {
      ...
      return "object" === e ? (this.length && !t.data(this, a) && (h = new n(this, i), this.each(function() {
          t.data(this, a, h)
      })), this) : "string" === e && "destroy" === i ? (h.destroy(), this.each(function() {
          t.removeData(this, a)
      }), this) : "number" === e && i % 1 === 0 ? (h.validNewPage(i) && h.paginate(i), this) : this
  }
